...
export const LocationEditor: React.FC<LocationEditorProps> = ({
  ...
  // Create modal content for mobile
  const modalContent = showMobileModal ? (
    ...
    return (
      <div className="group relative">
        ...
        <div className="flex items-start justify-between gap-2">
          <p className="text-slate-800 flex-1">{displayLocation()}</p>
          <button
            onClick={() => showMobileModal("Edit Location", modalContent)}
            className="p-1.5 rounded-lg hover:bg-slate-100 transition-all flex-shrink-0"
