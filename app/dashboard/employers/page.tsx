...
import Nav from '@/app/components/employernav';
                ...
                <div className="mx-auto  max-w-9xl px-6 md:px-10 py-20 md:py-30">
                    <div className="flex items-center justify-between gap-10 my-10 mx-20 md:">
                        <div className="text-white">
                            ...
                            <h1 className="text-5xl max-w-7xl font-medium leading-tight md:text-6xl">Hire Quality Talent, <br/> Fast.</h1>
                            <p className="mt-4  text-white/80 font-extralight">Post your job to thousands of verified, active job seekers.<br/> Fill your roles in days, not months.</p>
                            <div className="mt-8 flex flex-wrap gap-3">
                                <a className="rounded-lg bg-white px-5 py-3 text-[#1e5b86] font-extralight shadow" href="#">Post a Job for Free</a>
                                <a className="rounded-lg border border-white/60 px-5 py-3 font-extralight text-white/90" href="#">Schedule a Demo</a>
                            </div>
                        </div>
                        <div className="relative max-w-xl">
                            <div className=" p-3">
                                <div className="relative rounded-4xl overflow-hidden  ">
                                    <Image src={ hero} alt="hero" className="rounded-xl" width={740} height={500}/>
                                </div>
                            </div>
                            <div className="absolute -bottom-6 right-4 w-70 rounded-2xl bg-white p-4 text-black shadow-xl">
                                <p className=" tracking-wide font-extralight text-black text-base">Trusted by</p>
                                <p className="text-3xl font-light my-4">8,000+</p>
                                <p className="font-extralight text-base text-black ">businesses across Nigeria, from startups to established brands.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-[#1e5b86] text-white font-sans">
                <div className="mx-auto max-w-6xl px-6 md:px-10 py-16 md:py-24">
                    <div className="mx-auto mb-8 flex w-[158px] max-w-sm items-center justify-center gap-2 bg-white rounded-full px-3 py-4 text-black">
                        <span><Image src={ tinystar} alt='tiny star' /></span>
                        <span className="text-base font-medium">Testimonials</span>
                    </div>
                    <h2 className="text-center text-3xl font-medium tracking-normal  mb-4 md:text-5xl">Solutions for Your Business</h2>
                    <p className="mt-1 text-center font-extralight text-white/70">Hire for Any Role, Any Sector</p>
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 font-sans">
                        {industries.map(([icon, title, desc], i) => (
                            ...
                            >
                                ...
                                <h3 className="text-base font-medium w-full font-sans">{title}</h3>
            ...
            <section className="bg-white">
                <div className="mx-auto max-w-6xl px-6 md:px-10 py-16 md:py-24">
                    <div className="mx-auto mb-8 flex w-[148px] max-w-xs items-center justify-center gap-2 rounded-full border-gray-400 border px-5 py-4 ">
                        <span><Image src={tinystar} alt="tinystar"/></span>
                        <span className="text-sm font-semibold">Talents</span>
                    </div>
                    <h2 className="font-light text-center text-5xl -tracking-normal my-5">Featured Talent Pool</h2>
                            ...
                            <article key={i} className="rounded-2xl border border-slate-200 p-5 shadow-sm">
                                <div className="flex flex-col items-start gap-3">
                                    <div className="flex items-center ">
                                        ...
                                        <div>
                                            <h3 className="font-semibold">{['Tunde Kelai', 'Richard Etim', 'Adam Musa'][i % 3]}</h3>
                                        </div>
                                   </div>
                                       <div> <p className="text-slate-600 text-xl  font-semibold mb-2">Sales Assistant</p>
                                        <p className="text-[16px] font-light text-slate-500">Hardworking and ready to start immediately.</p>
                                    </div>
                                </div>
            ...
            <section className="bg-[#1e5b86] text-white">
                <div className="mx-auto max-w-6xl px-6 md:px-10 py-16 md:py-24">
                    <div className="mx-auto mb-8 flex w-[162px] max-w-xs items-center justify-center gap-2 rounded-full bg-white px-2 py-4">
                        <span><Image src={tinystar} alt=""/></span>
                        <span className="text-sm font-semibold text-black">Testimonials</span>
                    </div>
                    <div className="mb-30">
                        <h2 className="font-light text-center text-5xl -tracking-normal my-5">Solutions for Your Business</h2>
                    ...
                    <div className="mt-12 grid grid-cols-1 items-center gap-8 md:grid-cols-3">
                        <div className="order-2 text-center md:order-1 md:text-left mr-30 ">
                            <div className="flex flex-col justify-center items-center mb-30">
                                ...
                                <h3 className="mt-2 font-light tracking-normal  text-[20px]">Verified Candidates</h3>
                                <p className="text-sm w-full max-w-sm  text-white/80 text-center">ID-checked profiles with references for peace of mind.</p>
                            </div>
                            <div className="mt-10 flex flex-col justify-center items-center ">
                                <p className="text-5xl font-light ">2</p>
                                <h3 className="mt-2 font-light text-[20px]">Smart Matching</h3>
                                <p className="text-sm w-full max-w-sm  text-white/80 text-center">Algorithm highlights the most qualified applicants for your role.</p>
                            </div>
                        </div>
                        ...
                        <div className="order-1 mx-auto md:order-2">
                            ...
                            <div className="rounded-[2rem] bg-white p-3 relative">
                                <div className="">
                                    <Image src={solutions} alt="solution hero img" width={500} height={500} className= ""/>
                               </div>
                            </div>
                        </div>
                        ...
                        <div className="order-3 text-center md:text-left ml-30">
                            <div className="flex flex-col justify-center items-center mb-30">
                                ...
                                <h3 className="mt-2 font-light text-[20px]">All-in-One Dashboard</h3>
                                <p className="text-sm w-full max-w-sm  text-white/80 text-center">Manage job posts, applications, and messaging from a single platform.</p>
                            </div>
                            <div className="mt-10 flex flex-col justify-center items-center ">
                                <p className="text-5xl font-light">4</p>
                                <h3 className="mt-2 font-light text-[20px]">Cost-Effective</h3>
                                <p className="text-sm w-full max-w-sm  text-white/80 text-center">Reach thousands of job seekers with no hidden fees.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-6 md:px-10 py-16">
                    <div className="grid items-center gap-10 rounded-3xl bg-[#346b92]/90 px-25 py-10 md:grid-cols-2">
                        <div className="text-white ">
                            ...
                            <h3 className="text-5xl font-light tracking-normal font-dmsans">Start Hiring Smarter Today</h3>
                            <p className="my-8  font-sans text-[14px] font-extralight text-white/80">Join thousands of companies saving time and money on recruitment.</p>
                            <div className="mt-6">
                                <a className="rounded-lg bg-white px-5 py-3 font-extralight text-[#1e5b86] shadow" href="#">Post Your First Job</a>
                            </div>
                        </div>
